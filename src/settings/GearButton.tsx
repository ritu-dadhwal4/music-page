...
export function GearButton({ onClick }: { onClick: () => void }) {
  return (
    <button
      ...
      className="fixed top-4 right-4 z-30 flex h-11 w-11 items-center justify-center rounded-full bg-surface-container-lowest/90 text-on-surface shadow-md backdrop-blur transition-colors hover:text-primary focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
    >
